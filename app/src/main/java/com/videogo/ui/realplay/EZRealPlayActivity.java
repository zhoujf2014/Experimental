...
import com.gtafe.experimental.R;//experimental_service
    ...
    private void startRealPlay() {
        ...
        if (mCameraInfo != null) {
            ...
            if (mDeviceInfo.getIsEncrypt() == 1) {
                ...
                LogUtil.debugLog(TAG, "VerifyCode="+DataManager.getInstance().getDeviceSerialVerifyCode(mCameraInfo.getDeviceSerial()));
